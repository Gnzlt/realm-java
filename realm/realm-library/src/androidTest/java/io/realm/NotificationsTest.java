...
public class NotificationsTest extends AndroidTestCase {
    ...
    //FIXME test failing since Table.sync throws RuntimeException for now (waiting for Core to expose Table.m_version)
    public void testAsyncRealmObjectShouldNotBlockBackgroundCommitNotification() throws Throwable {
        ...
        TestHelper.exitOrThrow(executorService, signalTestFinished, signalClosedRealm, backgroundLooper, threadAssertionError, 6000);
    }
}
